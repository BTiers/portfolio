...
var CalendarEntries = memo3(() => {
  const [monthEntries] = useAtom(monthEntriesAtom);
  return /* @__PURE__ */ jsx2(Fragment, {
    children: monthEntries.map(
      (entry, index) => entry.isWeek ? /* @__PURE__ */ jsx2(WeekCell, {
        cell: entry
      }, index) : /* @__PURE__ */ jsx2(DayCell, {
        cell: entry
      }, index)
    )
  });
...
import { atom as atom2, useAtom as useAtom2, useSetAtom as useSetAtom2 } from "jotai";
import { AiOutlineCaretLeft, AiOutlineCaretRight } from "react-icons/ai";
import { jsx as jsx3, jsxs as jsxs2 } from "react/jsx-runtime";
var formattedSelectedMonthAtom = atom2(
  (get) => format(get(selectedMonthAtom), "MMMM, yyy")
);
var CalendarHeader = memo4(() => {
  const [formattedSelectedMonth] = useAtom2(formattedSelectedMonthAtom);
  const setSelectedMonthAtom = useSetAtom2(selectedMonthAtom);
  const setSelectedDayAtom = useSetAtom2(selectedDayAtom);
      ...
      /* @__PURE__ */ jsxs2("div", {
        ...
        children: [
          /* @__PURE__ */ jsx3("button", {
            ...
            children: /* @__PURE__ */ jsx3(AiOutlineCaretLeft, {
              className: "h-5 w-5"
            })
          }),
          /* @__PURE__ */ jsx3("button", {
          ...
          /* @__PURE__ */ jsx3("button", {
            ...
            children: /* @__PURE__ */ jsx3(AiOutlineCaretRight, {
              className: "h-5 w-5"
            })
          })
        ]
...
var CalendarColumnHeaders = memo5(() => {
...
var selectedDayAtom = atom3(new Date());
var selectedMonthAtom = atom3(startOfMonth(new Date()));
var Calendar = memo6(({ id }) => {
  return /* @__PURE__ */ jsxs3("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs3("div", {
        ...
        children: [
          /* @__PURE__ */ jsx5(CalendarColumnHeaders, {}),
          /* @__PURE__ */ jsx5(CalendarEntries, {})
        ]
      })
    ]
  });
...
import { memo as memo7, useState } from "react";
import { useInterval } from "react-use";
import { Fragment as Fragment3, jsx as jsx6, jsxs as jsxs4 } from "react/jsx-runtime";
var FIVE_SECOND = 5e3;
var CalendarLabel = memo7(() => {
