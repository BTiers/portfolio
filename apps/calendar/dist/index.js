...
// src/components/CalendarEntries.tsx
...
var DayCell = (0, import_react.memo)(({ cell }) => {
  ...
  if (cell.isToday)
    ...
    dayCellClassnames += "text-gray-400 hover:bg-gray-700";
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    className: dayCellClassnames,
    onClick: () => setSelectedDayAtom(() => cell.date),
    children: format(cell.date, "d")
  }, cell.index);
});
...
var WeekCell = (0, import_react2.memo)(({ cell }) => {
  const columnHeaderClassnames = "flex justify-center font-medium items-center text-gray-300 text-center bg-gray-900";
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", {
    className: columnHeaderClassnames,
    children: [
      "W ",
      cell.index
    ]
...
var monthEntriesAtom = (0, import_jotai2.atom)((get) => {
  ...
  const monthDaysEntries = Array.from({ length: 48 }).map((_, index) => {
    ...
    const daySettings = {
      ...
      isWithinSelectedMonth: getMonth(get(selectedMonthAtom)) === getMonth(currentDay),
...
var CalendarEntries = (0, import_react3.memo)(() => {
  const [monthEntries] = (0, import_jotai2.useAtom)(monthEntriesAtom);
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, {
    children: monthEntries.map(
      (entry, index) => entry.isWeek ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(WeekCell, {
        cell: entry
      }, index) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(DayCell, {
        cell: entry
      }, index)
    )
  });
...
var formattedSelectedMonthAtom = (0, import_jotai3.atom)(
  (get) => format(get(selectedMonthAtom), "MMMM, yyy")
);
var CalendarHeader = (0, import_react4.memo)(() => {
  const [formattedSelectedMonth] = (0, import_jotai3.useAtom)(formattedSelectedMonthAtom);
  const setSelectedMonthAtom = (0, import_jotai3.useSetAtom)(selectedMonthAtom);
  const setSelectedDayAtom = (0, import_jotai3.useSetAtom)(selectedDayAtom);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", {
    className: "text-base font-medium text-gray-100 flex justify-between",
    children: [
      formattedSelectedMonth,
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", {
        className: "shrink-0 space-x-2 flex items-center",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_ai.AiOutlineCaretLeft, {
              className: "h-5 w-5"
            })
          }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_ai.AiOutlineCaretRight, {
              className: "h-5 w-5"
            })
          })
        ]
...
// src/components/CalendarColumnHeaders.tsx
var import_react5 = require("react");
var import_jsx_runtime5 = require("react/jsx-runtime");
var DAYS_IN_WEEK = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
var CalendarColumnHeaders = (0, import_react5.memo)(() => {
  const columnHeaderClassnames = "flex justify-center font-medium text-base items-center text-gray-200 text-center h-16 w-16";
...
var selectedDayAtom = (0, import_jotai4.atom)(new Date());
var selectedMonthAtom = (0, import_jotai4.atom)(startOfMonth(new Date()));
var Calendar = (0, import_react6.memo)(({ id }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", {
    className: "flex flex-col space-y-2 text-[10px]",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(CalendarHeader, {}),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", {
        className: "grid grid-cols-8 gap-0",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(CalendarColumnHeaders, {}),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(CalendarEntries, {})
        ]
      })
    ]
  });
...
// src/CalendarPresentation.tsx
var import_react7 = require("react");
var import_react_use = require("react-use");
var import_jsx_runtime7 = require("react/jsx-runtime");
var FIVE_SECOND = 5e3;
var CalendarLabel = (0, import_react7.memo)(() => {
